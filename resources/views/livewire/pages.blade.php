<div class="p-6">
                            ...
                            @if ($data->count())
                                ...
                                <tr>
                                    <td class="px-6 py-4 text-sm whitespace-no-wrap">
                                        ...
                                        {!! $item->is_default_not_found ? '<span class="text-blue-400 text-xs font-bold">[Default 404 Page]</span>':'' !!}
                                    </td>
                                    <td class="px-6 py-4 text-sm whitespace-no-wrap">
                                        <a
    ...
    <x-jet-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <label>
                    ...
                    <span class="ml-2 text-sm text-red-600">Set as the default error page 404</span>
                </label>
            </div>
            <div class="mt-4">
        ...
        {{-- <x-slot name="anotherContent">
            Anything you put in here will be displayed inside the modal.
        </x-slot> --}}
